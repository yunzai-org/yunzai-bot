...
export declare class Runtime {
    #private;
    constructor(e: Parameters<EventEmun['message.group']>[0] | Parameters<EventEmun['message.private']>[0]);
    get handler(): {
        "__#44109@#events": {};
        add(cfg: any): void;
    ...
    getUid(): Promise<any>;
    getMysApi(targetType?: string, option?: {}, isSr?: boolean): Promise<false | MysApi>;
